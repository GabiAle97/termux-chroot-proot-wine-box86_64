...
You can set up everything using this command in Termux (Github version):
    ...
    pkg update -y && pkg install -y wget && wget https://raw.githubusercontent.com/GabiAle97/termux-chroot-proot-wine-box86_64/main/Scripts/Getting_Started.sh && chmod +x Getting_Started.sh && ./Getting_Started.sh && rm Getting_Started.sh
